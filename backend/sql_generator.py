...
batch_ids = [1, 2, 3, 4, 5] sql_statements = []
...
CREATE TABLE Accounts (
    ...
    Account Number VARCHAR(20) NOT NULL UNIQUE,
...
--BatchRuns
INSERT INTO BatchRuns (BatchDate, Status, Records Processed, StartedAt, EndedAt, Notes) VALUES
...
for i in range(1, 501):
    ...
    sql statements.append(f"""
INSERT INTO Customers (CustomerId, CustomerName, Email, Phone Number, DateOfBirth, BatchId, BatchStatus, ExternalSyncTimestamp) 
...
INSERT INTO Accounts (AccountId, AccountNumber, CustomerId, AccountType, Opening Date, CurrentBalance, BatchId, BatchStatus, ExternalsyncTimestamp) 
VALUES ({i}, {acc_num}', {i}, {acc_type}', '{open_date}, {balance}, {batch_id}, {acc_status}', '{acc_sync_time}');""")
    ...
    sql_statements.append(f"""
INSERT INTO CustomerAddresses (AddressId, CustomerId, AddressLinel, Addressline2, City, State, PostalCode, Country, AddressType, BatchId)
VALUES ({1}, {1}, {address1}', NULL, '{city}', '{state}', '{zip_code}', '{country}', '{addr_type}', {batch_id}); """)
    ...
    sql statements.append(f"""
INSERT INTO Transactions (TransactionId, AccountId, Date, Amount, LoanBalance, BatchId, BatchStatus, ExternalSyncTimestamp) ExternalSyncTimestamp) 
